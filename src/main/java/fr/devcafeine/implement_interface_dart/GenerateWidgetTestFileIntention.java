...
public class GenerateWidgetTestFileIntention extends HelperCreateTestFile implements IntentionAction {

    @Override
    public @IntentionName @NotNull String getText() {
        return "Create or open widget test file";
    }
    ...
    void createTestFile(Project project, String filename, PsiDirectory psiDirectory) {
        ...
        FileTemplate template = templateManager.getInternalTemplate("Dart Widget Test File");
